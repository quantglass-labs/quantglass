  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-lg font-semibold text-zinc-100">{t('academy.practice')}</h2>
      </div>
      ...
      {!mastery ? (
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3">
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
            <p className="text-xs text-zinc-500">{t('academy.level')}</p>
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
            <p className="text-xs text-zinc-500">{t('academy.streak')}</p>
            ...
            <p className="mt-1 text-[11px] text-zinc-600">{t('academy.keepsItAlive')}</p>
          </div>
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-4">
            <p className="text-xs text-zinc-500">{t('academy.badges')}</p>
            <p className="mt-1 flex items-center gap-1.5 text-lg font-semibold text-zinc-100">
              <Medal size={16} className={earned.length ? 'text-emerald-400' : 'text-zinc-600'} />
              {earned.length} / {mastery.badges.length}
            </p>
            <p className="mt-1 text-[11px] text-zinc-600">{t('academy.onePerTrack')}</p>
          </div>
        </div>
      )}
