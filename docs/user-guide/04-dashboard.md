...
The Dashboard is your **cross‑market command centre**. It answers four questions at a glance: *What's the regime? How am I positioned? Where are the signals? What's leading?*
...
| **Market Regime** | A derived read of overall conditions — e.g. *Risk‑On / Trending*, *Mixed / Rotational* — based on the current signal inventory. |
...
- **Source and timeframe** of the candles (e.g. *LIVE 1H VIA CCXT_COINBASE*, *LIVE 1D VIA YAHOO_PUBLIC*).
- A **mini sparkline** of recent price action.
- A **diagnostics** note describing data integrity (e.g. *partial_latest_candle_excluded*, *gaps_detected*) — this is how the app stays honest about closed‑candle‑only data.
...
- **Symbol** and **timeframe** (e.g. *BTC/USD · 15m*).
